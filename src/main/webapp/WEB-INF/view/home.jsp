		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <a class="nav-link" href="addTrade">Add Trade</a>
		        </li>
		      </ul>  
		    </div>
		  </div>
			            ...
			            <div class="card-body">
			            	...
			            	<table class="table">
								  <thead>
								    <tr>
								      <th scope="col">Id</th>
								      <th scope="col">Trade Date Time</th>
								  ...
								  <c:forEach items="${tradeList }" var="trade">
									<tr>
										...
										<td>
										    <a href="editTrade/${trade.id}" class="btn btn-sm btn-primary">Edit</a> 
										    <a href="deleteTrade/${trade.id }" class="btn btn-sm btn-danger">Delete</a>
										</td>
									</tr>
								</c:forEach>
								  </tbody>
